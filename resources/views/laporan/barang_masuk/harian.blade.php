...
@section('content')
    <div class="d-flex justify-content-between mb-3">
        <h3 class="text-primary"><i class="bx bx-package"></i> Laporan Barang Masuk Harian</h3>
        <form action="{{ route('laporan.barang_masuk.harian.pdf') }}" method="GET" target="_blank">
    ...
    <div class="card">
        <div class="mt-3 mb-3 col-lg-3">
            <form action="{{ route('laporan.barang_masuk.harian') }}" method="GET" class="d-flex gap-2">
                @csrf
    ...
    <div class="card mt-3">
        <h5 class="card-header">Laporan Barang Masuk Harian</h5>
        <div class="card-body">
